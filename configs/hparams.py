...
class HAR():
    def __init__(self):
        ...
        self.alg_hparams = {
            ...
            'MMDA': {'learning_rate': 1e-3, 'src_cls_loss_wt': 6.13, 'mmd_wt': 2.37, 'coral_wt': 8.63,
                     'cond_ent_wt': 7.16},
            'CDAN': {'learning_rate': 1e-2, 'src_cls_loss_wt': 5.19, 'domain_loss_wt': 2.91, 'cond_ent_wt': 1.73},
            'DIRT': {'learning_rate': 5e-4, 'src_cls_loss_wt': 7.00, 'domain_loss_wt': 4.51, 'cond_ent_wt': 0.79,
                     'vat_loss_wt': 9.31},
...
class EEG():
    def __init__(self):
        ...
        self.alg_hparams = {
            ...
            'MMDA': {'learning_rate': 0.0005, 'src_cls_loss_wt': 4.48, 'mmd_wt': 5.951, 'coral_wt': 3.36,
                     'cond_ent_wt': 6.13, },
            'CDAN': {'learning_rate': 0.001, 'src_cls_loss_wt': 6.803, 'domain_loss_wt': 4.726, 'cond_ent_wt': 1.307, },
            'DIRT': {'learning_rate': 0.005, 'src_cls_loss_wt': 9.183, 'domain_loss_wt': 7.411, 'cond_ent_wt': 2.564,
                     'vat_loss_wt': 3.583, },
            'SASA': {'learning_rate': 0.001, 'src_cls_loss_wt': 0.9752, 'domain_loss_wt': 0.3892},
...
class WISDM():
    def __init__(self):
        ...
        self.alg_hparams = {
            ...
            'DIRT': {'learning_rate': 1e-3, 'src_cls_loss_wt': 0.1, 'domain_loss_wt': 0.1, 'cond_ent_wt': 0.1,
                     'vat_loss_wt': 0.1},
            'SASA': {'learning_rate': 0.001, 'src_cls_loss_wt': 0.9752, 'domain_loss_wt': 0.3892},
            'CoTMix': {'learning_rate': 0.001, 'mix_ratio': 0.72, 'temporal_shift': 14,
                       'src_cls_weight': 0.98, 'src_supCon_weight': 0.1, 'trg_cont_weight': 0.1,
                       'trg_entropy_weight': 0.05}
...
class HHAR():
    def __init__(self):
        ...
        self.alg_hparams = {
            ...
            'MMDA': {'learning_rate': 0.001, 'src_cls_loss_wt': 0.9505, 'mmd_wt': 0.5476, 'cond_ent_wt': 0.5167,
                     'coral_wt': 0.5838, },
            'CDAN': {'learning_rate': 0.001, 'src_cls_loss_wt': 0.6636, 'domain_loss_wt': 0.1954,
                     'cond_ent_wt': 0.0124},
            'DIRT': {'learning_rate': 0.001, 'src_cls_loss_wt': 0.9752, 'domain_loss_wt': 0.3892,
                     'cond_ent_wt': 0.09228, 'vat_loss_wt': 0.1947},
            'SASA': {'learning_rate': 0.001, 'src_cls_loss_wt': 0.9752, 'domain_loss_wt': 0.3892},
